...
namespace Viso
{
  ...
  vector<int32_t> VisualOdometryMono::getInlier(vector<Matcher::p_match> &p_matched, Matrix &F)
  {
    ...
    double f00 = F.val[0][0];
    double f01 = F.val[0][1];
    double f02 = F.val[0][2];
    double f10 = F.val[1][0];
    double f11 = F.val[1][1];
    double f12 = F.val[1][2];
    double f20 = F.val[2][0];
    double f21 = F.val[2][1];
    double f22 = F.val[2][2];
