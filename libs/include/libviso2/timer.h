...
namespace Viso
{
  ...
  private:
    ...
    std::vector<std::chrono::high_resolution_clock::time_point> time;
    void push_back_time()
    {
    ...
    float getTimeDifferenceMilliseconds(std::chrono::high_resolution_clock::time_point a, std::chrono::high_resolution_clock::time_point b)
    {
